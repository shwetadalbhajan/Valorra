    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('salary', 'Salary'), ('food', 'Food'), ('transport', 'Transport'), ('shopping', 'Shopping'), ('investment', 'Investment'), ('entertainment', 'Entertainment'), ('other', 'Other')], max_length=20)),
